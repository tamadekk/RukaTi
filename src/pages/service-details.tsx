      ...
      <div className="space-y-8 font-mono">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="border border-black p-6 bg-white space-y-4">
            <h2 className="text-sm font-bold uppercase text-gray-400 tracking-wider mb-2">
              Service Provider
            </h2>
            {providerProfile?.user_id && (
              ...
              >
                ...
                <div>
                  <div className="font-bold text-lg group-hover:underline decoration-2 underline-offset-2">
